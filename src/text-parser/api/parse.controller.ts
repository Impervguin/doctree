import { Controller, UsePipes, ValidationPipe, Get, Param, HttpException, HttpStatus } from '@nestjs/common';
...
import { NoParserFoundError, FileNotFoundError } from '../services/errors.service';
...
export class ParseController {
    ...
    @ApiResponse({ status: 200, description: 'File parsed', type: ParseFileResponse })
